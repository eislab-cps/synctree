...
This means: Your **identity is self-sovereign** — owned and controlled by you.  
...
- The `ownerID` is the **SHA3 hash** of the public key.
...
This design provides a **lightweight, DID-compatible model** optimized for **offline-capable, peer-to-peer** data synchronization.
